...
class CenterHead(nn.Module):
    ...
    def forward(self, data_dict,Model_mode):
        spatial_features_2d = data_dict['spatial_features_2d']


        cls_preds = self.conv_cls(spatial_features_2d) # [1, 1, 800, 1408]
        box_preds = self.conv_box(spatial_features_2d) # [1, 8, 800, 1408]
    ...
    def get_targets_single(self,gt_bboxes_3d,gt_labels_3d):
        ...
        feature_map_size = grid_size[:2] // self.target_cfg["OUT_SIZE_FACTOR"] # [1408,800]
        ...
        for idx in range(1):
            heatmap = gt_bboxes_3d.new_zeros(
                (len(self.class_names[idx]), feature_map_size[1],     # [1,800,1408]
                 feature_map_size[0]))
            ...
            for k in range(num_objs):
                # if task_boxes[idx][k][3] == 0 and task_boxes[idx][k][4] == 0:
                #     continue
                ...
                if width>0 and length >0 and cls_id >-1: 
